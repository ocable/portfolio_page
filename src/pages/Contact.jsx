...
export default function Contact() {
  return (
    <div className="flex flex-col items-center mb-48">
      <h1 className="text-4xl md:text-5xl font-bold mt-10">Contact</h1>
        ...
        <a href="mailto:orionfcable@gmail.com">
          <div className="flex flex-col items-center">
            <svg
              ...
              height="80"
              viewBox="0 0 24 24"
              className="w-10 h-10 mx-4 md:mx-20 md:hover:scale-125 dark:fill-white"
            >
              <path d="M12 .02c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm6.99 6.98l-6.99 5.666-6.991-5.666h13.981zm.01 10h-14v-8.505l7 5.673 7-5.672v8.504z" />
            </svg>
            <h2 className="mt-2 md:mt-4 text-md md:text-xl font-semibold">Email</h2>
          </div>
        </a>

        <a href="https://github.com/ocable">
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
            ...
            <h2 className="mt-2 md:mt-4 text-md md:text-xl font-semibold">GitHub</h2>
          </div>
        </a>

        <a href="https://www.linkedin.com/in/orioncable/">
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
            ...
            <h2 className="mt-2 md:mt-4 text-md md:text-xl font-semibold">Linkedin</h2>
          </div>
        </a>

        <a href="https://drive.google.com/file/d/1qy6ENb7w2FoZXWRzpUIVCd33cifLWFYn/view?usp=sharing">
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
            ...
            <h2 className="mt-2 md:mt-4 text-md md:text-xl font-semibold">Resume</h2>
          </div>
        </a>
      </section>
    </div>
