...
export default function Contact() {
  ...
  const email = "orionfcable@gmail.com";
  ...
  return (
    <div className="flex flex-col items-center mb-80">
      ...
      <section className="flex flex-row mt-32">
        <div onClick={() => navigator.clipboard.writeText(email)} className="flex flex-col items-center">
          <svg
        ...
        <a href="https://github.com/ocable">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-4 text-xl">GitHub</h2>
          </div>
        </a>
        ...
        <a href="https://www.linkedin.com/in/orioncable/">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-4 text-xl">Linkedin</h2>
          </div>
        </a>
        ...
        <a href="https://drive.google.com/file/d/1qy6ENb7w2FoZXWRzpUIVCd33cifLWFYn/view?usp=sharing">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-4 text-xl">Resume</h2>
          </div>
        </a>
      </section>
    </div>
