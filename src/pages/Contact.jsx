  ...
  return (
    <div className="flex flex-col items-center mb-48">
      ...
      <section className="flex flex-row mt-12 md:mt-32">
        <a href="mailto:orionfcable@gmail.com" target="_blank">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-2 md:mt-4 text-md md:text-xl font-semibold">
              Email
            </h2>
          </div>
        </a>

        <a href="https://github.com/ocable" target="_blank">
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
        ...
        <a href="https://www.linkedin.com/in/orioncable/" target="_blank">
          <div className="flex flex-col items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="80"
        ...
        <a
          href="https://drive.google.com/file/d/1ADpfwujQiKE0r9qYAw6ivpNVLm_U7JLX/view?usp=sharing"
          target="_blank"
        >
          <div className="flex flex-col items-center">
            <svg
